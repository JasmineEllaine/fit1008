...
def test_updateValues():
    ...
    assert test_hash["Rosa"] == "Rosa", "Test failed #21: Value did not change upon assignment"
    assert test_hash["Captain"] == "Amy", "Test failed #21: Value did not change upon assignment"
